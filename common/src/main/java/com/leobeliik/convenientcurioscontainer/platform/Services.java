...
public class Services {
    ...
    public static <T> T load(Class<T> clazz, Services.class.getClassLoader()) {

        final T loadedService = ServiceLoader.load(clazz)
                .findFirst()
                .orElseThrow(() -> new NullPointerException("Failed to load service for " + clazz.getName()));
        LoggerFactory.getLogger(ConvenientCuriosContainerCommon.MODID).debug("Loaded {} for service {}", loadedService, clazz);
